 ...
 */
public class ConciertoAdapter extends ArrayAdapter<ProgramaClass> {
    ...
    public ConciertoAdapter(Context context, List<ProgramaClass> objects, DBAdapter dbAdapter) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            vi = inflater.inflate(R.layout.rowinf,parent, false);
