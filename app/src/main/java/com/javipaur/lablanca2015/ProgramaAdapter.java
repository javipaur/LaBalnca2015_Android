 ...
 */
public class ProgramaAdapter extends ArrayAdapter<ProgramaClass>{
    ...
    public ProgramaAdapter(Context context, List<ProgramaClass> objects, DBAdapter dbAdapter) {
           ...
           /* dia.setText("Dia " + (position + 1));
            ...
            favorito.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    TextView tv = (TextView)rl.findViewById(R.id.favorito);
